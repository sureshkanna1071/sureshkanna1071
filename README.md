...
I'm a
Full Stack Web Developer. Enthusiastic about learning new skills and implementing and launching new websites. The crossover between design and programming has always been of interest to me.
I have a wide range of skills that include back-end development using open source technologies (NodeJs), design (Blender 3D), front-end development (ReactJs, HTML5, CSS3, Javascript, Responsive, UX), Server Administrator(AWS), database(MongoDB, Mysql).
